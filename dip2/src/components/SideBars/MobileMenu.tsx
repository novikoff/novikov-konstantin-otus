...
import {mobileMenuClose, overLayerClose} from "../../redux/actions/actionOverLayer";
...
function MobileMenu(props:any) {
    ...
    const linkClickHandler = (e:any,link:string)=>{
        ...
        return (
            <>
                <div className={`mobile-menu-active clickalbe-sidebar-wrapper-style-1 ${props.mobileMenu?"mobilemenu-visible":""}`}>
                {/*<div className="mobile-menu-active clickalbe-sidebar-wrapper-style-1 mobilemenu-visible">*/}

                    <div className="clickalbe-sidebar-wrap">
                        <a className="sidebar-close" onClick={()=>{props.onMobileMenuClose()}}><i className=" ti-close "></i></a>
                        <div className="mobile-menu-content-area sidebar-content-100-percent">
                            ...
                            <div className="clickable-mainmenu-wrap clickable-mainmenu-style1">
                                <nav>
                                    <ul>
                                        <li className="has-sub-menu"><a href="#">Home<span className="menu-expand"><i
                                            className=" ti-plus "></i></span></a>
                                            <ul className="sub-menu-2" style={{display: 'none'}}>
                                                <li className="has-sub-menu"><a href="#">Demo Group 01<span
                                                    className="menu-expand"><i className=" ti-plus "></i></span></a>
                                                    <ul className="sub-menu-2" style={{display: 'none'}}>
                                                ...
                                                <li className="has-sub-menu"><a href="#">Demo Group 02<span
                                                    className="menu-expand"><i className=" ti-plus "></i></span></a>
                                                    <ul className="sub-menu-2" style={{display: 'none'}}>
                                        ...
                                        <li className="has-sub-menu"><a href="#">Pages<span className="menu-expand"><i
                                            className=" ti-plus "></i></span></a>
                                            <ul className="sub-menu-2" style={{display: 'none'}}>
                                        ...
                                        <li className="has-sub-menu"><a href="#">shop<span className="menu-expand"><i
                                            className=" ti-plus "></i></span></a>
                                            <ul className="sub-menu-2" style={{display: 'none'}}>
                                                <li className="has-sub-menu"><a href="#">Shop Layout<span
                                                    className="menu-expand"><i className=" ti-plus "></i></span></a>
                                                    <ul className="sub-menu-2" style={{display: 'none'}}>
                                                ...
                                                <li className="has-sub-menu"><a href="#">Product Layout<span
                                                    className="menu-expand"><i className=" ti-plus "></i></span></a>
                                                    <ul className="sub-menu-2" style={{display: 'none'}}>
                                                ...
                                                <li className="has-sub-menu"><a href="#">Shop Page<span
                                                    className="menu-expand"><i className=" ti-plus "></i></span></a>
                                                    <ul className="sub-menu-2" style={{display: 'none'}}>
                                        ...
                                        <li className="has-sub-menu"><a href="#">Blog<span className="menu-expand"><i
                                            className=" ti-plus "></i></span></a>
                                            <ul className="sub-menu-2" style={{display: 'none'}}>
                            ...
                            <div className="mobile-curr-lang-wrap">
                                <div className="single-mobile-curr-lang">
                                    <a className="mobile-language-active" href="#">Language <i
                                ...
                                <div className="single-mobile-curr-lang">
                                    <a className="mobile-currency-active" href="#">Currency <i
                                        className="fa fa-angle-down"></i></a>
                            ...
                            <div className="header-aside-content">
                                <div className="header-aside-payment">
                                    <img src="/images/icon-img/payment.png" alt="payment" />
                                </div>
                                ...
                                <div className="aside-contact-info">
                                    <ul>
                                        ...
                                        <li><i className=" ti-home "></i>Helios Tower 75 Tam Trinh Hoang - Ha Noi - Viet
                                            Nam
                                        </li>
                                    </ul>
                                </div>
...
function mapDispatchToProps(dispatch: any) {
    return {
        ...
        onMobileMenuClose: ()=>dispatch(mobileMenuClose()),
