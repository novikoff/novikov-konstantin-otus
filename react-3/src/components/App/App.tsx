...
import {Actions,addNumber,addAsync,LoadCities,setApiKey} from '../../redux/action/actions';
import SelectCity from './../SelectCity/SelectCity';
import NavEl from '../NavEl/NavEl';
import {Route} from 'react-router-dom';
import { withRouter } from "react-router";
import City from './../City/City';
const cities_json: {[key: string]: any} = require('../../data/current.city.list.min.json');
    ...
    render(){
        return(
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-12">
                        {this.props.full_cities_list && this.props.full_cities_list.length > 0 &&
                        <SelectCity/>
                        }
                    </div>
                </div>
